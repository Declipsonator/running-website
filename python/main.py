...
def get_people():
    ...
    page_number = 1
    page = json.loads(json.loads(get_page(page_number)))
    people = {}
...
def get_page(number):
    link = f'https://www.yentiming.com/leaderboard/get?limit=49&sex=M&events%5B%5D=6&events%5B%5D=7&events%5B%5D=8&events%5B%5D=9&events%5B%5D=10&events%5B%5D=13&events%5B%5D=15&events%5B%5D=25&events%5B%5D=26&events%5B%5D=27&events%5B%5D=28&events%5B%5D=29&events%5B%5D=30&events%5B%5D=31&events%5B%5D=32&events%5B%5D=33&events%5B%5D=34&events%5B%5D=35&events%5B%5D=36&events%5B%5D=37&events%5B%5D=38&events%5B%5D=39&events%5B%5D=40&events%5B%5D=43&events%5B%5D=44&events%5B%5D=45&events%5B%5D=46&events%5B%5D=51&events%5B%5D=52&events%5B%5D=54&events%5B%5D=65&events%5B%5D=69&events%5B%5D=75&events%5B%5D=76&events%5B%5D=77&events%5B%5D=78&events%5B%5D=80&events%5B%5D=100&events%5B%5D=101&events%5B%5D=107&events%5B%5D=109&events%5B%5D=110&teams%5B%5D=85&season=indoor&year=2025&classs=&league=&name=&page={number}&sort_order=ASC&_=1739047933965'
...
save.convert_to_csv(runners)
top_5 = get_top_5_per_event(runners)
save.convert_top_5_to_csv(top_5)
...
# relay_legs = ['800m', '800m', '800m', '800m']
# best_relays = relays.fastest_relays(runners, relay_legs, num_relays=10)
#
# print("Top relay combinations:")
# for team, total in best_relays:
#     print(f"Team: {team}, Total time (sec): {total:.2f}")
